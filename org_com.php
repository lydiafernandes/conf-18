...
<!-- -------------------------------------------------->
	<div class="container-fluid">
		<h1 style="text-align:center"> International Science Conference <br> 2019 </h1>
<!-- row 1 begins -->
		<div class="row">
		...
		<div class="row">
    		<div class="col-sm-3" style="background-color:#cbcdd9;">&nbsp;</div>
				...
				<span class="sec_box" style="float:right;">
					...
					<strong>St. Xavier&apos;s  College <br>   Provost/Vice Principal Academics <br>Head, Dept. of Chemistry</strong>  </a>
   		 		</span>
       ...
       <!-- row 9 begins -->
		<div class="row">
    		<div class="col-sm-3" style="background-color:#cbcdd9;">&nbsp;</div>
   		 	...
   		 	<div class="col-sm-2 pad_center" style="background-color:#230A52;border-style:none;">
