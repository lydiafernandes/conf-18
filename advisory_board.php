...
<ul class="faq">
    ...
    <li class="q">
        ...
        Padma Bhushan Dr. N. K. Ganguly
    </li>
    <li class="a">
    <div class="col-sm-2" style="float:left;">
        <img src="img\board_pics\nk_ganguly.png">
    </div>
    Dr. Nirmal Kumar Ganguly <br>
...
<li class="q">
        <img src="img/arrow.png"> 
        Padma Shri Dr. Mustansir Barma (TIFR)
    </li>
...
<li class="q">
    ...
    as well as industry. Her work is in the field of cancer cell biology, imaging and pre-clinical drug
     discovery. Her basic research is focused on cell motility related signal transduction events and
